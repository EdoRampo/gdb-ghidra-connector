...
GHIDRA_HOST=auto
GHIDRA_PORT=18932    
while getopts "m:H:p:G:g:h" opt; do
    case "$opt" in
        m) MODE="$OPTARG" ;;
        ...
        h) echo "用法: $0 -m <gdb|ghidra> -H <backend_host> -p <backend_port> -G <ghidra_host> -g <ghidra_port>"; exit 0 ;;
        *) exit 1 ;;
    esac
done
...
then
    ...
    -g /path/to/ghidra_12.0.4_PUBLIC -G $GHIDRA_HOST:$GHIDRA_PORT -V .venv
else
